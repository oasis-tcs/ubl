...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0">
  <xsl:variable name="udt" as="element()*">
    <div>
      <a name="UDT"/>
      ...
      <table frame="border" rules="all" summary="Unqualified data types" class="uT">
        ...
        <tr valign="top">
          ...
          <td>optional</td>
          <td>xsd:normalizedString</td>
          <td>(Deprecated) The VersionID of the UN/ECE Rec9 code list.</td>
        </tr>
        <tr>
        ...
        <tr valign="top">
          ...
          <td>optional</td>
          <td>xsd:normalizedString</td>
          <td>(Deprecated) The character set of the binary object if the mime type is text.</td>
        </tr>
        <tr valign="top">
          ...
          <td>optional</td>
          <td>xsd:normalizedString</td>
          <td>(Deprecated) Specifies the decoding algorithm of the binary object.</td>
        </tr>
        <tr valign="top">
          ...
          <td>optional</td>
          <td>xsd:string</td>
          <td>(Deprecated) The filename of the binary object.</td>
        </tr>
        <tr valign="top">
          ...
          <td>optional</td>
          <td>xsd:string</td>
          <td>(Deprecated) The format of the binary content.</td>
        </tr>
        <tr valign="top">
          ...
          <td>optional</td>
          <td>xsd:anyURI</td>
          <td>(Deprecated) The Uniform Resource Identifier that identifies where the binary object is located.</td>
        </tr>
        <tr>
          <td valign="top" rowspan="7">
        ...
        <tr valign="top">
          ...
          <td>optional</td>
          <td>xsd:language</td>
          <td>(Deprecated) The identifier of the language used in the code name.</td>
        </tr>
        <tr valign="top">
          ...
          <td>optional</td>
          <td>xsd:normalizedString</td>
          <td>(Deprecated) An agency that maintains one or more lists of codes.</td>
        </tr>
        <tr valign="top">
          ...
          <td>optional</td>
          <td>xsd:string</td>
          <td>(Deprecated) The name of the agency that maintains the list of codes.</td>
        </tr>
        <tr valign="top">
        ...
        <tr valign="top">
          ...
          <td>optional</td>
          <td>xsd:string</td>
          <td>(Deprecated) The name of a list of codes.</td>
        </tr>
        <tr valign="top">
          ...
          <td>optional</td>
          <td>xsd:anyURI</td>
          <td>(Deprecated) The Uniform Resource Identifier that identifies where the code list scheme is located.</td>
        </tr>
        <tr valign="top">
          ...
          <td>optional</td>
          <td>xsd:anyURI</td>
          <td>(Deprecated) The Uniform Resource Identifier that identifies where the code list is located.</td>
        </tr>
        <tr valign="top">
          ...
          <td>optional</td>
          <td>xsd:normalizedString</td>
          <td>(Deprecated) The version of the list of codes.</td>
        </tr>
        <tr valign="top">
          <td>CodeNameText</td>
          <td>name</td>
          <td>optional</td>
          <td>xsd:string</td>
          <td>(Deprecated) The textual equivalent of the code content component.</td>
        </tr>
        <tr>
        ...
        <tr valign="top">
          ...
          <td>optional</td>
          <td>xsd:normalizedString</td>
          <td>(Deprecated) The identification of the agency that maintains the identification scheme.</td>
        </tr>
        <tr valign="top">
          ...
          <td>optional</td>
          <td>xsd:string</td>
          <td>(Deprecated) The name of the agency that maintains the identification scheme.</td>
        </tr>
        <tr valign="top">
          ...
          <td>optional</td>
          <td>xsd:anyURI</td>
          <td>(Deprecated) The Uniform Resource Identifier that identifies where the identification scheme data is located.</td>
        </tr>
        <tr valign="top">
        ...
        <tr valign="top">
          ...
          <td>optional</td>
          <td>xsd:string</td>
          <td>(Deprecated) The name of the identification scheme.</td>
        </tr>
        <tr valign="top">
          ...
          <td>optional</td>
          <td>xsd:anyURI</td>
          <td>(Deprecated) The Uniform Resource Identifier that identifies where the identification scheme is located.</td>
        </tr>
        <tr valign="top">
          ...
          <td>optional</td>
          <td>xsd:normalizedString</td>
          <td>(Deprecated) The version of the identification scheme.</td>
        </tr>
        <tr>
          <td valign="top" rowspan="1">
        ...
        <tr valign="top">
          ...
          <td>optional</td>
          <td>xsd:normalizedString</td>
          <td>(Deprecated) The version of the measure unit code list.</td>
        </tr>
        <tr>
        ...
        <tr valign="top">
          ...
          <td>optional</td>
          <td>xsd:string</td>
          <td>(Deprecated) Whether the number is an integer, decimal, real number or percentage.</td>
        </tr>
        <tr>
          <td valign="top" rowspan="2">
        ...
        <tr valign="top">
          ...
          <td>optional</td>
          <td>xsd:normalizedString</td>
          <td>(Deprecated) The identification of the agency that maintains the quantity unit code list</td>
        </tr>
        <tr valign="top">
          ...
          <td>optional</td>
          <td>xsd:string</td>
          <td>(Deprecated) The name of the agency which maintains the quantity unit code list.</td>
        </tr>
        <tr valign="top">
          ...
          <td>optional</td>
          <td>xsd:normalizedString</td>
          <td>(Deprecated) The quantity unit code list.</td>
        </tr>
        <tr>
          <td valign="top" rowspan="3">
        ...
        <tr valign="top">
          ...
          <td>optional</td>
          <td>xsd:normalizedString</td>
          <td>(Deprecated) The identification of the locale of the language.</td>
        </tr>
        <tr>
          <td valign="top" rowspan="3">
